...
embedContexts :: (DynGraph gr) => Context (Node gr) a b -> [gr a b] -> [gr a b]
...
------------------------------------------------------------------------------
findGraph :: (DynGraph gr) => Node gr -> [gr a b] -> (Decomp gr a b, [gr a b])
...
------------------------------------------------------------------------------
splitGraphs :: (DynGraph gr) => [gr a b] -> [Node gr] -> [gr a b]
splitGraphs gs []     = gs
